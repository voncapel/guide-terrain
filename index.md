...
Nous remercions également chaleureusement les discutantes : **Divya Leducq, Sonia Le Gouriellec, Claire Marynower, Irène Mestre, Anastasiya Shapochkina, Alina Surubaru et Wendy Ramadan**, pour la finesse de leurs éclairages, leurs retours critiques et leur soutien aux chercheuses en formation.

Merci aux personnes qui nous ont accompagnées : Tristan Chapelle pour le design et la réalisation du site ainsi que la relecture attentive effectuée par Christine, Hélène, Juliette, Maël, Maela, Mélanie et Sarah. Nous tenons également à remercier le laboratoire Territoires, Villes, Environnement & Société (TVES)  et l’Institut de Recherche Stratégique de l’Ecole Militaire, IRSEM Europe pour leur soutien.
...
### Positionnalité et rapports de pouvoir {#positionnalite-et-rapports-de-pouvoir}

> Qui est la chercheuse dans le terrain, comment est-elle lue, quelles structures sociales la traversent ?
<p class="toolbox_hint">Cette réflexion peut être formalisée avant le départ à l’aide de l’<a href="{{ '/outils/#outil-1' | relative_url }}">Outil 1</a>.</p>
...
### Risques, vulnérabilités et émotions {#risques-vulnerabilites-emotions}
...
<p class="toolbox_hint">Cette cartographie est proposée dans l’<a href="{{ '/outils/#outil-1' | relative_url }}">Outil 1</a> (Identification des risques) et discutée conjointement dans l’<a href="{{ '/outils/#outil-2' | relative_url }}">Outil 2</a>.</p>
...
### Pratiques d'enquête, adaptations et éthique {#pratiques-enquete-adaptations-ethique}
...
<p class="toolbox_hint">Les alternatives méthodologiques en cas de fermeture d’un site, d’un pays ou d’un interlocuteur peuvent être appréhendées avec l’encadrante à l’aide de l’<a href="{{ '/outils/#outil-2' | relative_url }}">Outil 2</a>.</p>
#### Bonnes pratiques identifiées
{: .good-practices-title}
...
<p class="toolbox_hint">Les étapes concrètes de préparation sont déclinées dans les <a href="{{ '/outils/#outil-1' | relative_url }}">Outils 1 à 3</a> : auto-positionnement et identification des risques (<a href="{{ '/outils/#outil-1' | relative_url }}">Outil 1</a>), évaluation conjointe avec l’encadrante (<a href="{{ '/outils/#outil-2' | relative_url }}">Outil 2</a>), préparation logistique et checklist (<a href="{{ '/outils/#outil-3' | relative_url }}">Outil 3</a>).</p>
...
### Et tes proches ? {#et-tes-proches-avant}
...
### Recommandations aux institutions {#recommandations-institutions-avant}
...
<p class="toolbox_hint">Pour une auto-surveillance quotidienne des signaux d’alerte, voir l’<a href="{{ '/outils/#outil-4' | relative_url }}">Outil 4</a>.</p>
...
### Et tes proches ? {#et-tes-proches-terrain}
...
### Et ta santé ? {#et-ta-sante-terrain}
...
### Symptômes de choc secondaire ou traumatismes vicariants : à surveiller {#symptomes-choc-secondaire}
...
### Recommandations aux institutions {#recommandations-institutions-terrain}
...
<p class="toolbox_hint">Le retour d’expérience et la sécurisation des données font l’objet d’une section dédiée dans l’<a href="{{ '/outils/#outil-2' | relative_url }}">Outil 2</a> (section RETEX) et de points de vigilance dans l’<a href="{{ '/outils/#outil-3' | relative_url }}">Outil 3</a> (au retour : anonymisation et sécurisation).</p>
...
### Et tes proches ?  {#et-tes-proches-retour}
...
### Et ta santé ?  {#et-ta-sante-retour}
...
### Recommandations aux institutions  {#recommandations-institutions-retour}
...
[Commission européenne : index des risques par pays](http://drmkc.jrc.ec.europa.eu/inform-index/INFORM-Risk/Risk-Facts-Figures) : une évaluation comparative des vulnérabilités et des risques par pays.

[France Diplomatie : conseils par pays/destination](https://www.diplomatie.gouv.fr/fr/conseils-aux-voyageurs/conseils-par-pays-destination/) : des fiches officielles fournissant une lecture synthétique des risques sécuritaires.

[Fédération internationale des sociétés de la Croix-Rouge et du Croissant-Rouge : profil de pays](https://go.ifrc.org/countries/217/profile/overview) : des profils opérationnels décrivant les crises en cours.

[Organisation Mondiale de la Santé : conseils de voyage](https://www.who.int/travel-advice) : des recommandations sanitaires par pays.

[ONU \- Bureau de la coordination des affaires humanitaires (OCHA) : profil de pays](https://reliefweb.int/countries) : des synthèses actualisées des contextes humanitaires.

[UMIFRE (MEAE \- CNRS)](https://www.umifre.fr/) : instituts de recherche implantés par grandes régions du monde.


## Qui sommes-nous ? {#qui-sommes-nous}
 
> Ce guide a été conçu et coordonné par Marie Hiliquin, Eugénie Masclef, Anastasia Protassov, à l’initiative du cycle de séminaires Femmes et terrains : vers la création d’outils méthodologiques.

Nous sommes chercheuses en sciences sociales, engagées dans des travaux de terrain en contextes internationaux et sensibles, et confrontées, à différents moments de nos parcours, aux enjeux méthodologiques, éthiques et personnels que ce guide aborde.

Ce projet est né d’un double constat : d’une part, le manque de ressources formalisées sur les expériences de terrain des femmes ; d’autre part, la richesse des savoirs produits de manière informelle, souvent transmis entre pairs, de manière fragmentée ou tardive.

Notre rôle dans ce guide n’est pas de proposer un cadre normatif, mais de mettre en forme, structurer et rendre accessibles des expériences et des pratiques partagées collectivement lors des séminaires. Ce document reflète une démarche collaborative, nourrie par une pluralité de trajectoires, de disciplines et de terrains.
